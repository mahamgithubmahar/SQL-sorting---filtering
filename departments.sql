...
SELECT COUNT(EMPLOYEE_ID) FROM DEPARTMENT GROUP BY DEPARTMENT_ID;
SELECT SUM(SALARY) FROM DEPARTMENT GROUP BY DEPARTMENT_ID;
SELECT COUNT(EMPLOYEE_ID) , SUM(SALARY) FROM DEPARTMENT GROUP BY DEPARTMENT_ID;
SELECT DEPARTMENT_ID, SUM(SALARY) FROM DEPARTMENT WHERE MANAGER_ID='103' GROUP BY DEPARTMENT_ID;
SELECT DEPARTMENT_ID FROM DEPARTMENT GROUP BY DEPARTMENT_ID HAVING COUNT(*)>2;